export default function SocialIcons() {
  return (
    ...
    >
      ...
      >
        <svg
          className="w-6 h-6 text-gray-500 hover:text-red-500 transition transform group-hover:-translate-y-1 group-hover:scale-125 duration-200"
          fill="currentColor"
          viewBox="0 0 24 24"
        >
